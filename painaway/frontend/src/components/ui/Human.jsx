...
const Human = ({ interactive, currentNote }) => {
  ...
  const intensityMapByBodyPart = useMemo(() => {
    ...
    if (currentNote) {
      ...
      if (part) {
        map[part.translation] = currentNote.intensity
      }
    }
    else {
      notes.forEach((note) => {
        map[note.bodyPartName] = note.intensity
      })
    }
  ...
  return (
    <div className="human-body">
      ...
      >
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Голова'] ?? 0}`}
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Лицо'] ?? 0}`}
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Шея'] ?? 0}`}
          id="neck"
          data-name="Шея"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левое плечо'] ?? 0}`}
          id="shoulder-left"
          data-name="Левое плечо"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правое плечо'] ?? 0}`}
          id="shoulder-right"
          data-name="Правое плечо"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая рука'] ?? 0}`}
          id="arm-left"
          data-name="Левая рука"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левое предплечье'] ?? 0}`}
          id="forearm-left"
          data-name="Левое предплечье"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая рука'] ?? 0}`}
          id="arm-right"
          data-name="Правая рука"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правое предплечье'] ?? 0}`}
          id="forearm-right"
          data-name="Правое предплечье"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая часть груди'] ?? 0}`}
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая часть живота'] ?? 0}`}
          ...
          id="belly-left"
          data-name="Левая часть живота"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левые рёбра'] ?? 0}`}
          id="ribs-left"
          data-name="Левые рёбра"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая часть живота'] ?? 0}`}
          ...
          id="belly-right"
          data-name="Правая часть живота"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Живот'] ?? 0}`}
          id="belly"
          data-name="Живот"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правые рёбра'] ?? 0}`}
          id="ribs-right"
          data-name="Правые рёбра"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левое бедро'] ?? 0}`}
          id="thigh-left"
          data-name="Левое бедро"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая внутренняя часть бедра'] ?? 0}`}
          id="innerthigh-left"
          data-name="Левая внутренняя часть бедра"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая ступня'] ?? 0}`}
          ...
          id="feet-left"
          data-name="Левая ступня"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая икра'] ?? 0}`}
          id="calf-left"
          data-name="Левая икра"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левое колено'] ?? 0}`}
          id="knee-left"
          data-name="Левое колено"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правое бедро'] ?? 0}`}
          id="thigh-right"
          data-name="Правое бедро"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Гениталии'] ?? 0}`}
          id="genitalia"
          data-name="Гениталии"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая внутренняя часть бедра'] ?? 0}`}
          id="innerthigh-right"
          data-name="Правая внутренняя часть бедра"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая ступня'] ?? 0}`}
          ...
          id="right-feet"
          data-name="Правая ступня"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая икра'] ?? 0}`}
          id="calf-right"
          data-name="Правая икра"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правое колено'] ?? 0}`}
          id="knee-right"
          data-name="Правое колено"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правый локтевой сустав'] ?? 0}`}
          d="m 3.2054751,27.370125 0.005,3.09419 -0.57959,1.91184 -0.54539,-2.41185 z"
          id="elbow-right"
          data-name="Правый локтевой сустав"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая ладонь'] ?? 0}`}
          ...
          id="hand-right"
          data-name="Правая ладонь"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левый локтевой сустав'] ?? 0}`}
          d="m 28.325215,27.370125 -0.005,3.09419 0.57959,1.91184 0.54538,-2.41185 z"
          id="elbow-left"
          data-name="Левый локтевой сустав"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая ладонь'] ?? 0}`}
          ...
          id="hand-left"
          data-name="Левая ладонь"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая задняя часть плеча'] ?? 0}`}
          id="armback-left"
          data-name="Левая задняя часть плеча"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая нога (сзади)'] ?? 0}`}
          id="leg-left"
          data-name="Левая нога (сзади)"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Ягодицы'] ?? 0}`}
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Поясница'] ?? 0}`}
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Затылок'] ?? 0}`}
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая задняя часть плеча'] ?? 0}`}
          id="armback-right"
          data-name="Правая задняя часть плеча"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая нога (сзади)'] ?? 0}`}
          id="leg-right"
          data-name="Правая нога (сзади)"
        ...
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая задняя часть спины'] ?? 0}`}
          ...
          id="back-right"
          data-name="Правая задняя часть спины"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Правая ключица'] ?? 0}`}
          d="m 55.439085,14.728535 -0.063,-2.62463 0.71441,1.15181 4.37994,1.49796 -4.97857,8.36746 -1.83043,5.08189 0.21949,-13.55362 z"
          id="clavicle-right"
          data-name="Правая ключица"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая задняя часть спины'] ?? 0}`}
          ...
          id="back-left"
          data-name="Левая задняя часть спины"
          onClick={handleBodyClick}
        />
        <path
          className={`body__part intensity-${intensityMapByBodyPart['Левая ключица'] ?? 0}`}
          d="m 49.625175,14.629325 0.063,-2.62462 -0.71441,1.15181 -4.37994,1.49796 4.97857,8.36746 1.83043,5.08188 -0.21949,-13.55362 z"
          id="clavicle-left"
          data-name="Левая ключица"
          onClick={handleBodyClick}
        />
      </svg>
    </div>
